...
class reporte_vial : AppCompatActivity() {
    ...
    fun insertar(view: View) {
        if (validarCamposVacios()) {
            ...
            if (networkInfo != null && networkInfo.isConnected) {
                ...
                Toast.makeText(this@reporte_vial, "No hay conexión a Internet", Toast.LENGTH_LONG).show()
            }
        }
    }
    ...
    private fun validarCamposVacios(): Boolean {
        ...
        return if (descripcion.isEmpty() || referencias.isEmpty()) {
            Toast.makeText(this@reporte_vial, "Por favor, completa todos los campos", Toast.LENGTH_LONG).show()
            false
        } else {
            true
        }
